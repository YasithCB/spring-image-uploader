 ...
 * created 2/7/2023 - 2:03 PM
 * project spring-image-uploader
 */
@Configuration
@EnableTransactionManagement
@EnableJpaRepositories(basePackageClasses = {ImageDataRepo.class})
public class JPAConfig {
    ...
    public DataSource dataSource(){
        ...
        ds.setUrl("jdbc:mysql://localhost:3306/spring_image_upload?createDatabaseIfNotExist=true");
        ds.setUsername("root");
        ds.setPassword("1234");
        return ds;
    }
